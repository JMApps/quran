...
class LayoutDatabaseService {
  LayoutDatabaseService._();
  static final LayoutDatabaseService instance = LayoutDatabaseService._();

  static const String _dbFileName = 'qpc-v2-15-lines.db';
