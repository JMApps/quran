...
class SurahsDatabaseService {
  SurahsDatabaseService._();
  static final SurahsDatabaseService instance = SurahsDatabaseService._();

  static const String _dbFileName = 'surah_info.db';
